...
import { AlertTriangle, BookOpen, Check, CheckCircle2, Clock3, FileText, Search, ShieldCheck, X } from "lucide-react";
import { toast } from "sonner";
import { aircraft } from "@/data/aircraft";
import { directives, type Directive } from "@/data/mock/compliance";
  ...
  return (
    <section className="compliance-view" aria-label="Compliance tracking">
      <header className="page-heading">
        ...
        <Badge variant="outline" className="compliance-demo-badge">Demo data · May 2026 snapshot</Badge>
      </header>
